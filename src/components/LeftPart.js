...
const PortfolioLeftSection = () => {
  return (
    <div className="portfolio-holder__left-holder">
      <AnimatedHeading />
      <div className="portfolio-holder__left-content">
        <div className="portfolio-holder__left-content-holder">
          <h2 className="positin">Frontend & WordPress Developer</h2>
          <p className="discribe">
            Specialize in finding the best solutions for your website, combining
            pixel-perfect precision, responsiveness, and dynamic functionality.
          </p>
        </div>
...
export default PortfolioLeftSection;
